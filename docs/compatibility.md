...
- [x] [imap_createmailbox](https://github.com/javanile/php-imap2/issues?q=label%3Acreatemailbox)
- [x] [imap_delete](https://github.com/javanile/php-imap2/issues?q=label%3Adelete)
- [x] [imap_deletemailbox](https://github.com/javanile/php-imap2/issues?q=label%3Adeletemailbox)
- [x] [imap_errors](https://github.com/javanile/php-imap2/issues?q=label%3Aerrors)
- [ ] [imap_expunge](https://github.com/javanile/php-imap2/issues?q=label%3Aexpunge)
- [x] [imap_fetchbody](https://github.com/javanile/php-imap2/issues?q=label%3Afetchbody)
- [x] [imap_fetchheader](https://github.com/javanile/php-imap2/issues?q=label%3Afetchheader)
- [x] [imap_fetch_overview](https://github.com/javanile/php-imap2/issues?q=label%3Afetch_overview)
- [x] [imap_fetchstructure](https://github.com/javanile/php-imap2/issues?q=label%3Afetchstructure)
- [x] [imap_getmailboxes](https://github.com/javanile/php-imap2/issues?q=label%3Agetmailboxes)
...
- [x] [imap_open](https://github.com/javanile/php-imap2/issues?q=label%3Aopen)
- [x] [imap_ping](https://github.com/javanile/php-imap2/issues?q=label%3Aping)
- [x] [imap_reopen](https://github.com/javanile/php-imap2/issues?q=label%3Areopen)
- [ ] [imap_savebody](https://github.com/javanile/php-imap2/issues?q=label%3Asavebody)
- [x] [imap_search](https://github.com/javanile/php-imap2/issues?q=label%3Asearch)
...
- [x] [imap_status](https://github.com/javanile/php-imap2/issues?q=label%3Astatus)
- [ ] [imap_thread](https://github.com/javanile/php-imap2/issues?q=label%3Athread)
- [x] [imap_timeout](https://github.com/javanile/php-imap2/issues?q=label%3Atimeout)
